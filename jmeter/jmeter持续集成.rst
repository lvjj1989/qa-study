...
编写线程组时，将线程数与执行时间进行参数化处理，从 shell 脚本中获取参数值：
------------------------------------------------------------------------------------
...
备注：若在 shell 中未传递上述参数，则对应默认值为：线程数 400，执行时间 300 秒。


保存后将生成的 JMX 文件上传到 Linux 服务器对应路径上，配置 Jenkins 任务：
------------------------------------------------------------------------------------
...
若报告中数据无法正常显示，原因可能为 Jenkins 中 HTML 安全策略导致，
